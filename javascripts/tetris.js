...
(function() {
  ...
  $(function() {
    var down, left, pause, pause_status, refresh, resume, right, rotate, t, timer;
    t = new Tetris(12, 20);
    refresh = function() {
    ...
    test("scan lines to kill", function() {
      var r, tt;
      tt = new Tetris(3, 3);
      ...
      r = tt.scan_killable_lines();
      return deepEqual(r, [1, 2], "should find the last two lines is full to be killed");
    });
    test("find deadblocks", function() {
      var d, tt;
      tt = new Tetris(3, 3);
      tt.array = [0, 0, 0, 0, 0, 0, 2, 2, 2];
      d = tt.get_deadblock();
      ...
      tt.array = [0, 0, 0, 2, 2, 2, 2, 2, 2];
      d = tt.get_deadblock();
      return deepEqual(d, [3, 4, 5, 6, 7, 8], "should find the last elements are deadblocks");
    });
    return test("kill lines", function() {
      var i, tt;
      tt = new Tetris(3, 3);
      tt.array = [0, 0, 0, 0, 0, 0, 2, 2, 2];
      deepEqual([2], tt.scan_killable_lines(), "should scan right");
      tt.kill_lines(tt.scan_killable_lines());
      deepEqual(tt.get_array(), (function() {
        var _i, _results;
        _results = [];
      ...
      tt.kill_lines(tt.scan_killable_lines());
      return deepEqual(tt.get_array(), ((function() {
        var _i, _results;
        _results = [];
        ...
        return _results;
      })()).concat([0, 2, 0]), "should kill the last two lines");
    });
  });
